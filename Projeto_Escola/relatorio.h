...
int professores_ordenados_data_nascimento(professor p[], int *P_ativo);
int aniversariantes_mes(aluno a[], int *A_ativo);
int aniversariantes_mes_professor(professor p[], int *P_ativo);
...
int alunos_matriculados_menos_3_disciplinas(disciplina d[], int *D_ativa, aluno a[], int *A_ativo);
